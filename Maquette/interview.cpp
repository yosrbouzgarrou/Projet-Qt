...
bool interview::modifier(QString idd)//modifier invité
{
    ...
    query.prepare("Update INTERVIEW set ID_INTERVIEW=:id,NOM_JOURNALISTE=:NOM_JOURNALISTE ,DOMAINE=:DOMAINE,DATEE=:DATEE, ID_INVITE=:ID_INVITE where ID_INTERVIEW=:id ");
